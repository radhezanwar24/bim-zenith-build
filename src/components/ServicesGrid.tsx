    ...
    >
      {services.map(({ icon: Icon, title, desc }, i) => (
        ...
        >
          ...
          />
          <span className="relative grid h-11 w-11 place-items-center rounded-xl bg-gradient-to-br from-royal to-navy text-primary-foreground shadow-sm sm:h-12 sm:w-12">
            <Icon
              className="h-5 w-5 transition-transform duration-500 group-hover:scale-110 sm:h-6 sm:w-6"
              aria-hidden
            />
          </span>
